...
// ─── Pływające przyciski WhatsApp & Instagram ────────
(function injectFloatingButtons() {
  const wrapper = document.createElement('div');
  wrapper.className = 'floating-socials';
  wrapper.innerHTML = `
    <a href="https://wa.me/48573312722" target="_blank" rel="noopener noreferrer" class="floating-btn floating-btn-whatsapp" aria-label="WhatsApp">
    ...
    <a href="https://www.instagram.com/hello.beauty.studio/" target="_blank" rel="noopener noreferrer" class="floating-btn floating-btn-instagram" aria-label="Instagram">
